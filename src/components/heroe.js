...
function Heroe({ image, title, text, label, lien }) {
  ...
  return (
    <section className="px-4 bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xl md:px-4 py-4 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div className="mr-auto place-self-center lg:col-span-7">
                ...
                <Link href={lien} className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded bg-blue-800 hover:bg-blue-500 hover:border-transparent focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    {label}
                </Link> 
            </div>
